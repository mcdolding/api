///////////////////////////////////////////////////////////////////
// MCD
// Essentially a copy of address_search_using_ids
// Instead of requiring a "street",  this search requires "postcode"
////////////////////////////////////////////////////////////////////
const _ = require('lodash');
const peliasQuery = require('pelias-query');
const defaults = require('./search_defaults');
const PostcodeSearch = require('./layout/PostcodeUsingIdsQuery');

//------------------------------
// general-purpose search query
//------------------------------
const addressUsingIdsQuery = new PostcodeSearch();
...
function generateQuery( clean, res ){
  ...
  return {
    type: 'postcode address_search_using_ids',
